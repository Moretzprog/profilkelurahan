...
<section id="galeri" class="py-5 bg-light">
        <div class="container container-box">
            <h2 class="section-title text-center mb-5" data-aos="fade-up">Galeri Album Kegiatan</h2>
...
<!-- ===================== Konten Galeri ================== -->
            <div class="swiper mySwiper" id="gallery-albums">
                <div class="swiper-wrapper">
                    <?php
                    include 'koneksi.php';
                    $query = "SELECT * FROM t_galeri WHERE parent_id IS NULL OR parent_id = 0 ORDER BY tanggal_upload DESC";
                    ...
                    <div class="swiper-slide album-item" data-aos="fade-up" data-tags="<?= $kategori ?>">
                        ...
                        <div class="card-body text-center">
                            ...
                            <a href="galeri.php?slug=<?= htmlspecialchars($row['slug']) ?>" class="btn btn-outline-primary btn-sm rounded-pill">Lihat Album</a>
                        </div>
                        </div>
                    </div>
                    <?php } ?>
            ...
            <div class="text-center mt-5" data-aos="fade-up" data-aos-delay="300">
                <a href="all_album.php" class="btn btn-primary btn-lg rounded-pill shadow-sm px-5">
                    <i class="fas fa-images me-2"></i> Lihat Semua Album
                </a>
            </div>
        </div>
</section>
                ...
                <div class="col" data-aos="zoom-in" data-aos-delay="100">
                    <div class="card h-100 text-center">
                        <div class="card-body">
                            ...
                            <?php if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === TRUE): ?>
                                <a href="lembagakeamanan/src/beranda.php" class="btn btn-warning rounded-pill">Preview</a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
...
<section id="kontak" class="py-5 bg-dark text-white text-center">
        <div class="container position-relative" data-aos="fade-up">
            ...
            <?php
                include 'koneksi.php';
                $query = "SELECT * FROM t_contact WHERE id = 1 LIMIT 1";
                $result = mysqli_query($koneksi, $query);
            ...
            <p class="text-white" id="contact-address"><i class="fas fa-map-marker-alt me-2"></i><?php echo $row['alamat']; ?></p>
            <p class="text-white" id="contact-phone"><i class="fas fa-phone me-2"></i> <?php echo $row['telepon']; ?></p>
            <p class="text-white" id="contact-email"><i class="fas fa-envelope me-2"></i> <?php echo $row['email']; ?></p>
        </div>
            ...
            <div class="card bg-gradient bg-opacity-75 border-0 shadow-lg mx-auto" style="max-width: 700px; background: linear-gradient(135deg, #007bff 60%, #28a745 100%);">
                <div class="card-body p-4">
                    ...
                    <form class="row g-3 justify-content-center text-start" 
                        method="POST" action="pages/proses_saran.php" id="formSaran">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control rounded-end" id="nama" name="nama" placeholder="Nama Anda" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" class="form-control rounded-end" id="email" name="email" placeholder="email@contoh.com" required>
                            </div>
                        </div>
                        <div class="col-12">
                            <label for="pesan" class="form-label text-white fw-semibold">Pesan / Saran</label>
                            <textarea class="form-control rounded-3" id="pesan" name="saran" rows="4" placeholder="Tulis saran Anda di sini..." style="resize:none" required></textarea>
                        </div>
...
<div class="modal fade" id="saranModal" tabindex="-1" aria-labelledby="saranModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Daftar Pesan -->
                <div class="list-group" id="adminSaranList">
                    <?php
                    include 'koneksi.php'; // pastikan koneksi ke database

                    $query = "SELECT * FROM t_saran ORDER BY tanggal DESC";
                    $result = mysqli_query($koneksi, $query);
